...
export function EmptyState() {
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-4 pb-44 pt-14 text-center sm:px-8">
      <div className="qwen-mark qwen-mark-animated relative mb-7 grid size-20 place-items-center overflow-hidden rounded-3xl bg-code">
        <img src={qwenMark.url} alt="Qwen AI" className="size-full object-cover" />
      </div>
      <h2 className="text-3xl font-semibold text-foreground sm:text-4xl">How can I help?</h2>
