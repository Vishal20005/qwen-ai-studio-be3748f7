...
export function ChatApp() {
  ...
  return (
    <main className="relative flex h-dvh overflow-hidden bg-background text-foreground">
      <div className="hidden md:block"><Sidebar onSettings={() => setSettingsOpen(true)} onConversation={openConversation} /></div>
