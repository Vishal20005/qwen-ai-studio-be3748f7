  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[88vh] max-w-2xl overflow-y-auto rounded-2xl border-border/70 bg-background/95 p-0 shadow-composer backdrop-blur-xl">
        <DialogHeader className="border-b border-border/60 p-5 pr-12"><DialogTitle className="flex items-center gap-2"><Settings2 className="size-5 text-primary" />Settings</DialogTitle><DialogDescription>Fine-tune your Qwen AI workspace.</DialogDescription></DialogHeader>
        <div className="grid gap-6 p-5 sm:grid-cols-2">
          <section><h3 className="flex items-center gap-2 text-xs font-semibold uppercase text-muted-foreground">General</h3><Row label="Compact mode"><Switch /></Row><Row label="Enter to send"><Switch defaultChecked /></Row></section>
